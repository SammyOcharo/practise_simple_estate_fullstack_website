...
class Property(TimeStampedUUIDModel):
    ...
    class PropertyType(models.TextChoices):
        ...
        WAREHOUSE = "Waeehouse", _("Warehouse")
    ...
    description = models.TextField(verbose_name=_("Description"), default="Default...")
    ...
    street_address = models.CharField(verbose_name=_("Street Adress"), max_length=150, default="k9u kasarani")
    property_number = models.IntegerField(verbose_name=_("Property number"), validators= [MinValueValidator(1)], default=10)
